                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        Complete 10-page business plan with all essential sections
                      </p>
                    </div>
                  </div>
          ...
          >
            <div className="p-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder='{"companyName": "Your Company", "executiveSummary": ["Point 1", "Point 2"], "companyDescription": "Your company description...", "marketAnalysis": ["Market insight 1", "Market insight 2"]}'
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                <h4 className="font-semibold text-gray-900 mb-2">Supported JSON Keys:</h4>
                <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                  ...
                  <div>• serviceProductLine</div>
                  <div>• marketingSales</div>
                  <div>• fundingRequest</div>
                  <div>• financialProjections</div>
                  <div>• appendix</div>
                </div>
              </div>
            </div>
